 ...
 * It uses hashing to find a match between pattern and array of characters. It uses rolling hash function to relocate the hash on the subsequent possible matches.
